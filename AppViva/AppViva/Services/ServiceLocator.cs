...
namespace AppViva.Services
{
    public static class ServiceLocator
    {
        public static void RegisterDependencies()
        {
            ...
            IocContainer.RegisterAsSingleton<ILoginService, LoginService>();
            IocContainer.RegisterAsSingleton<IClassService, ClassService>();
        ...
        public static ILoginService LoginService => Resolve<ILoginService>();
